...
Luckily, browsers can do that for us, and it's a single line of code:
...
Personally, the more I can stay away from regexes, the better. I'm not saying rexeges should be avoided at all cost but it's just that they get thrown around a lot and are often not the right tool for the job.
