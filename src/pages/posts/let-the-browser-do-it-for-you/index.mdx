...
Having to deal with URLs is super common when developing websites.
...
In the past I've used the [qs](https://www.npmjs.com/package/qs) package to address these above issues but there is better alternative.
