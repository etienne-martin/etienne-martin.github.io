...
Browsers are an incredible feat of engineering. The Chromium codebase contains about [35 million lines of source code](<https://en.wikipedia.org/wiki/Chromium_(web_browser)#:~:text=35%20million%20source%20lines%20of%20code.>) according to wikipedia. It's honestly so mind boggling to me that they work at all.

While browsers can do a ton of stuff, there are things we developers have to implement ourselves because they are not supported natively.
